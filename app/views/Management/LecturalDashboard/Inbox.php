...
<link rel="stylesheet" href="<?=ASSETS?>RequirementJs/AdminFirstassets/css/summernote.css" />
...
<style>
  @font-face {
    ...
    font-style: normal;
    font-weight: normal;
    src: url("<?=ASSETS?>RequirementJs/AdminFirstassets/fonts/summernotef534.eot?ad8d7e2d177d2473aecd9b35d16211fb");
    src: url("<?=ASSETS?>RequirementJs/AdminFirstassets/fonts/summernoted41d.eot?#iefix") format("embedded-opentype"),url("<?=ASSETS?>RequirementJs/AdminFirstassets/fonts/summernotef534.woff?ad8d7e2d177d2473aecd9b35d16211fb") format("woff"),url("<?=ASSETS?>RequirementJs/AdminFirstassets/fonts/summernotef534.ttf?ad8d7e2d177d2473aecd9b35d16211fb") format("truetype");
}
.emailsection .print-icon::before { font-family: "Font Awesome 5 Free"; font-weight: 900; content: "\f02f";}
.emailsection .forward-icon::before { font-family: "Font Awesome 5 Free"; font-weight: 900; content: "\f3e5";}
.emailsection .dropdown-icon::before { font-family: "Font Awesome 5 Free"; font-weight: 900; content: "\f142";}
.emailsection .dropdownuser-icon::before { font-family: "Font Awesome 5 Free"; font-weight: 900; content: "\f0d7";}
</style>
</head>
...
<!-- Email  -->
<div class="emailsection" style="margin:20px">
  <div class="container">
    <div class="header">
      <span style="font-size:20px; font-weight:600"><?=$data['page_title']?></span>
      <span class="pull-right"><i class="print-icon" style="color:gray;margin-right:10px" title="Print all"></i>Inbox</span>
    </div>  
    <div class="emailprofile" style="margin-top:20px">
      <span class="avatar" style="background-image: url(<?=ASSETS?>assets/img/dp.jpg)"></span> 
      <span><?=$data['sendername']?> to me <i class="dropdownuser-icon" style="color:gray"></i></span>
      <span class="pull-right" style=""><i class="forward-icon" style="color:gray;margin-right:10px" title="Reply Message"></i></span>
      <span class="pull-right" style="margin-right:30px"><?=pretty_date($data['emailtimesent'])?></span>
   </div>
   <div class="emailbody">
    <span style="margin-top:20px;margin-bottom:20px;display: block;height: 0;padding: 0;border-top: 1px solid gray; border-bottom: 1px solid gray;"></span>
    <p><?=$data['emailbody']?></p>
   </div>
   <div class="emailfooter" style="margin-bottom:50px">
      <button class="pull-left btn btn-default btn-xs reply-btn" style="font-size:15px; ">Reply<i class="forward-icon" style="color:gray;margin-right:10px" title="Reply Message"></i></button>
   </div>
  </div>
</div>
          ...
          <div class="card">
            <div class="card-body mail_compose">
              <form method="POST" action="javascript:void(0)">
                <div class="form-group">
                  <input type="text" class="form-control" name="senderemail" id="senderemail" value="<?=$data['senderemail']?>" placeholder="To">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="subject" id="subject" value=""placeholder="Subject">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="copyemail" id="copyemail" value="" placeholder="CC">
                </div>
                <textarea id="emailtextarea" class="summernote" name="respondmessage" id="respondmessage" rows="10" cols="60">
                 
                </textarea>
                <div class="mt-4 text-right">
                  <button type="submit" class="btn btn-success">Send Message</button>
                  <button type="reset" class="btn btn-outline-secondary cancelbtn" >Cancel</button>
                </div>
              </form>
...
<script src="<?=ASSETS?>RequirementJs/AdminFirstassets/bundles/lib.vendor.bundle.js" ></script>
<script src="<?=ASSETS?>RequirementJs/AdminFirstassets/bundles/summernote.bundle.js"></script>
<script src="<?=ASSETS?>RequirementJs/AdminFirstassets/js/core.js"></script>
<script src="<?=ASSETS?>RequirementJs/AdminFirstassets/bundles/summernote.js" ></script>
<script src="<?=ASSETS?>RequirementJs/AdminFirstassets/js/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"></script>
<script>
  $(document).ready(($)=>{
    $("#emailBox").hide();
    $(".reply-btn").click(()=>{
