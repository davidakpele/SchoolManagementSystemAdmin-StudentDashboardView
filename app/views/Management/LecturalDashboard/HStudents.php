...
<style>
	...
	input[type="checkbox"] {background-color: #e7ffba;border: 1px solid gray;border-radius: 10px;width: 16px;height: 16px;accent-color: gray;}
...
<div class="notification d-flex">
		<div class="dropdown d-flex" id="emailbox">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
				...
				?>
					<li class="online">
						<a href="<?=((isset($emailid))?ROOT.'Management/Inbox?tab='.$emailid: '#')?>" class="media">
							<img class="media-object" src="../assets/images/xs/avatar4.jpg" alt="">
							<div class="media-body">
