                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form action="javascript:void(e)" method="post" autocomplete="off">
                            <input type="hidden" value="<?=$data['Dep']->DepartmentID?>" id="id" class="form-control">
                                <div class="form-group invalid">
                                    <label for="Depname">Departement Name: </label>
                                    <input type="text" data-id="<?=$data['Dep']->DepartmentID?>" value="<?=$data['Dep']->DepartmentName?>" id="isEditData" class="form-control">
