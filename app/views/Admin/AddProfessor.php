	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Add Lecturer <small>Add Lecturer Data</small>
				</h1>
				...
				<ol class="breadcrumb">
					...
					<li class="active">Add Lecturer Data</li>
				</ol>
			</section>
			<!-- Main content -->
				...
				<form action="javascript:void(0)" id="formdosen" method="post" accept-charset="utf-8" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="box">
						<div class="box-header with-border">
							<h3 class="box-title">Form Add Lecturer Data</h3>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-4 col-sm-12 col-xs-12">
										...
										<input type="text" class="form-control" name="Middle__name" id="Middle__name" value="" placeholder="Middle Name:"/>
									</div>
								</div>
								<div class="col-md-12">
									<div class="col-md-4 col-sm-12 col-xs-12">
									...
									<div class="col-md-4 col-sm-12 col-xs-12">
										...
										<input readonly type="text" class="form-control" name="Accesscode" id="Accesscode" value="<?=$data['accesscode']?>"  />
									</div>
									<div class="col-md-4 col-sm-12 col-xs-12">
								...
								<div class="col-md-12">
									<div class="col-md-4 col-sm-12 col-xs-12">
										...
										<input type="email" class="form-control" name="Email" id="Email" placeholder="Lecturer Email"/>
										<small class="help-block"></small>
									</div>	
									<div class="col-md-4 col-sm-12 col-xs-12">
										<label for="tel">Mobile:</label>
										<input type="tel" class="form-control" name="Telephone_No" id="Telephone_No" value="" placeholder="+(234) 5435-4542-34"/>
									</div>
									<div class="col-md-4 col-sm-12 col-xs-12">
								...
								<div class="col-md-12">
									<div class="col-md-4 col-sm-12 col-xs-12">
										...
										<input type="text" class="form-control" name="Place__of__birth" id="Place__of__birth" value="" placeholder="Lagos"/>
									</div>
									<div class="col-md-4 col-sm-12 col-xs-12">
								...
								<div class="col-md-12">
									<div class="col-md-4 col-sm-12 col-xs-12">
										<label for="Citizenship:">Citizenship:</label>
											<input type="text" class="form-control" name="Citizenship" id="Citizenship" value="" placeholder="Africa (Nigeria)"/>
									</div>
									<div class="col-md-4 col-sm-12 col-xs-12">
										<label for="NIN">NIN:</label>
										<input type="text" class="form-control" id="NIN" type="number" value="" placeholder="NIN:"/>
									</div>
									<div class="col-md-4 col-sm-12 col-xs-12">
								...
								<div class="col-md-12">
									...
									<div class="col-md-4 col-sm-12 col-xs-12">
										...
										<textarea class="form-control" name="Address" id="Address" value="" cols="0" rows="6" placeholder="Address: Plot 28 Kingstone Bridge K29Q HighWay"></textarea>
									</div>
								</div>
								<div class="col-md-12">
