...
$this->DB->query('SELECT * FROM super__administrator ');
    $row = $this->DB->single();
    if(!empty($row)){
        $AvaliableID = $row->Admin__id;
    }?>
    <!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style type="text/css">
        ...
        .success-ico {padding-left: 60px;background: url(http://localhost/student/public/assets/bullet_add.png) #E4FFDE no-repeat 30px center;}
...
<body>
    <div class="header-toggle container">
        <h2 class="text-center header-element">Admin Reset Password</h2>
    </div>
    ...
    <div class="mini-container login-widget"> 
        ...
        <form method="POST" action="javascript:void(0)" class="form-group" id="___UpdateAdminPassword" autocomplete="off">
            ...
            <div class="PhpHookSecurityAsycHidden">
             ...
             <div class="col-md-5">
                <input type="text" id="Userid" class="form-control" value="<?=$AvaliableID;?>" style="display:none"/>
            </div>
            <div class="element">
                <label>Old Confirm Password</label>
            ...
            <div class="element">
                ...
                placeholder="Newpassword" class="form-control" 
            ...
            <div class="element">
                ...
                placeholder="Confirm mpassword" class="form-control" 
                value="<?=((isset($_POST['Confirmpassword']))?$_POST['Confirmpassword']: '')?>"
                autocomplete="off"/>
            </div>
            <div class="element">
                <input type="submit" value="Reset Password"  class="btn btn-xs">
            </div>
        </form>
    </div>
  <div class="clearfix">
