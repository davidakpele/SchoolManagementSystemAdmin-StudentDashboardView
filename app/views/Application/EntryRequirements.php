<html>
    <head>
        ...
        <style type="text/css">
            .panel {max-width: 960px;width: 100%;margin: 0 auto;}
            @media screen and (max-width: 960px) {.panel {width: 90% !important;}}
        </style> 
    </head>
                ...
                <form method="POST" class="form-horizontal form-group">
                    <div class="form-ui-panel">
                        <div class="pane form-group">
                            <label id="apptypelabel" class="col-sm-12 col-md-3 col-lg-3 make-full">ApplicationType :</label>
                            <div class="col-sm-12 col-md-9 col-lg-9 select-drop-down">
                                <select class="form-control" name="Application__Type" id="Application__Type" style="width:75%;">
    ...
    <div class="container footer-wrap">
        <div class="row flex">
            ...
            <div class="col-sm-6 text-right pull-right footer-right">
                <p>Powered by <a href="http://localhost/MidTech/" style="text-decoration:none">MidTech Microsystem Pvt Ltd</a></p>
            </div>
        </div>
    </div>
</div>
