...
<head>
    ...
    <style type="text/css">
        ...
        label{color:#7D7D7D;}
        .header-element {font-size: 18px; tex-algin:center; color: #535353; padding-top:5px}
        ...
        .png{max-width:80px; display: block;  margin-left: auto; margin-right: auto;}
...
<body>
    <div class="header-toggle container">
        <h2 class="text-center header-element">Recover your Password</h2>
    </div>
