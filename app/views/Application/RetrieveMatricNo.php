...
<head>
    ...
    <style type="text/css">
        ...
        label{color:#7D7D7D;}
        .header-element {font-size: 18px; tex-algin:center; color: #535353; padding-top:32px}
...
<body>
    <div class="header-toggle container">
        <h2 class="text-center header-element">Retrieve Matric Number</h2>
    </div>
    <div class="mini-container login-widget"> 
        ...
        <form method="POST" action="javascript:void(0)" class="form-group" id="__Recoverform" autocomplete="off">
            ...
            <div class="element">
                ...
                <input name="ApplicatioNo" type="text" id="ApplicatioNo" value="<?=(isset($_POST['ApplicatioNo']))?$_POST['ApplicatioNo']: '' ?>" />
            </div>
            <div class="element">
                <label>Surname</label>
                <input name="Surname" type="text" id="Surname" value="<?=(isset($_POST['Surname']))?$_POST['Surname']: '' ?>"/>
            </div>
            <div class="element">
