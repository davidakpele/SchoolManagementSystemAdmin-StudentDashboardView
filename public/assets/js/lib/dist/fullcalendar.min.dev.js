  ...
  return function (t) {
    ...
    var i = n(2),
      ...
      return i.__extends(e, t), e.prototype.listenTo = function (t, e, n) {
        if ("object" == _typeof(e)) for (var i in e) {
    ...
    var i = n(2),
      ...
      return i.__extends(e, t), e.parse = function (t, e) {
        ...
        var i,
            r = this.eventDefs;
        if (null != this.currentTimezone && this.currentTimezone !== n) for (i = 0; i < r.length; i++) {
      ...
      return i.__extends(e, t), e.parse = function (t, e) {
        ...
        return this.calendar.pushLoading(), s["default"].construct(function (t, n) {
          r.ajax(r.extend({}, e.AJAX_DEFAULTS, l, {
            url: a.url,
            data: c,
            success: function success(e, i, s) {
              var l;
    ...
    var i = n(2),
      ...
      return i.__extends(e, t), e.prototype.queue = function (t, e, n) {
        ...
        var e,
            ...
            i = this.q,
            r = !0;
        if (t.namespace && "destroy" === t.type) for (e = i.length - 1; e >= 0; e--) {
          switch (n = i[e], n.type) {
            case "init":
              r = !1;
      ...
      return t.prototype.setToolbarOptions = function (t) {
        ...
        return u && i.each(u.split(" "), function (t, s) {
          ...
          i.each(s.split(","), function (t, s) {
            ...
            "title" === s ? (h = h.add(i("<h2>&nbsp;</h2>")), f = !1) : ((l = d[s]) ? (g = function g(t) {
